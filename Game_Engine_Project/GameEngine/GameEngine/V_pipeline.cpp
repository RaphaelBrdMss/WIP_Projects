...
void V_Pipeline::initGraphicsPipline (const std::string& vertPath, const std::string& fragPath,const Pipeline_configInfo &configInfo){
    ...
    pipeline_Info.pDynamicState =&configInfo.dynamicsSrtateInfo;
...
void V_Pipeline::defaultPiplineConfigInfo(Pipeline_configInfo& configInfo){
    ...
    configInfo.dynamicsStateEnable = {VK_DYNAMIC_STATE_VIEWPORT,VK_DYNAMIC_STATE_SCISSOR};
    configInfo.dynamicsSrtateInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO;
    configInfo.dynamicsSrtateInfo.pDynamicStates= configInfo.dynamicsStateEnable.data();
    configInfo.dynamicsSrtateInfo.dynamicStateCount = static_cast<uint32_t>(configInfo.dynamicsStateEnable.size());
    configInfo.dynamicsSrtateInfo.flags =0;
